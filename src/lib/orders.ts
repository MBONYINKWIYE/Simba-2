...
const baseOrderSelect =
  'id, created_at, pickup_time, subtotal_rwf, delivery_fee_rwf, service_fee_rwf, total_rwf, payment_method, payment_status, delivery_address, full_name, phone, shop_id, status, rejection_reason, momo_reference, momo_status, payment_provider, payment_payload, paid_at, delivery_person_name, delivery_person_phone, recurrence, next_delivery_date, order_items(id, product_id, product_name, quantity, unit_price_rwf)';
